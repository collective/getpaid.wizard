...
class DataManager(object):
    ...
    def reset(self):
        """ certain state operations like resetting the form variables are
        useful when resetting the form under error conditions to reset the step
        """
        # not meaningful in a form request scenario, a redirect will destroy
        # state, but useful for impl that use persistent server state
        self._state = {}
...
class ControllerBase(object):
    ...
    def transitionTo(self, step_name):
        ...
        # reset any saved request variables as they might be invalid in the new
        # state
